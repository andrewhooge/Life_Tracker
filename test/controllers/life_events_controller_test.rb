...
class LifeEventsControllerTest < ActionController::TestCase
  ...
  test "should create life_event" do
    assert_difference('LifeEvent.count') do
      post :create, life_event: { description: @life_event.description, ending_year: @life_event.ending_year, event: @life_event.event, string: @life_event.string, year: @life_event.year }
    end
  ...
  test "should update life_event" do
    patch :update, id: @life_event, life_event: { description: @life_event.description, ending_year: @life_event.ending_year, event: @life_event.event, string: @life_event.string, year: @life_event.year }
    assert_redirected_to life_event_path(assigns(:life_event))
  end
